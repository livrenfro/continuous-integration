# Continuous Integration ![https://github.com/livrenfro/continuous-integration/actions?query=workflow%3Atests](https://github.com/livrenfro/continuous-integration/workflows/tests/badge.svg)
...
Fork this repo, and clone your fork into the lambda server.
